...
test_parsing: lex.ritual-r5rs.o ritual-r5rs.tab.o parse_context.o test_parsing.o ritual_generic.o ritual_basic_types.o ritual_object.o ritual_flo.o ritual_gc.o ritual_instance.o
	gcc $(CFLAGS) $^ -o $@
